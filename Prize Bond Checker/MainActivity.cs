...
namespace Prize_Bond_Checker
{
    ...
    public class MainActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        {
            RelativeLayout contentMainLayout = FindViewById<RelativeLayout>(Resource.Id.child_container_prizebonds);
            //contentMainLayout.

            RelativeLayout addNewBondLayout = FindViewById<RelativeLayout>(Resource.Id.add_new_bond_popup);
